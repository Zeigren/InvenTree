...
part_attachment_urls = [
    ...
    url(
        r"^(?P<pk>\d+)/edit/?",
        views.PartAttachmentEdit.as_view(),
        name="part-attachment-edit",
    ),
    url(
        r"^(?P<pk>\d+)/delete/?",
        views.PartAttachmentDelete.as_view(),
        name="part-attachment-delete",
    ),
]
...
part_parameter_urls = [
    url(
        "^template/new/",
        views.PartParameterTemplateCreate.as_view(),
        name="part-param-template-create",
    ),
    url(
        "^template/(?P<pk>\d+)/edit/",
        views.PartParameterTemplateEdit.as_view(),
        name="part-param-template-edit",
    ),
    url(
        "^template/(?P<pk>\d+)/delete/",
        views.PartParameterTemplateDelete.as_view(),
        name="part-param-template-edit",
    ),
    url("^new/", views.PartParameterCreate.as_view(), name="part-param-create"),
    url(
        "^(?P<pk>\d+)/edit/", views.PartParameterEdit.as_view(), name="part-param-edit"
    ),
    url(
        "^(?P<pk>\d+)/delete/",
        views.PartParameterDelete.as_view(),
        name="part-param-delete",
    ),
]
...
part_detail_urls = [
    ...
    url(
        r"^params/",
        views.PartDetail.as_view(template_name="part/params.html"),
        name="part-params",
    ),
    url(
        r"^variants/?",
        views.PartDetail.as_view(template_name="part/variants.html"),
        name="part-variants",
    ),
    url(
        r"^stock/?",
        views.PartDetail.as_view(template_name="part/stock.html"),
        name="part-stock",
    ),
    url(
        r"^allocation/?",
        views.PartDetail.as_view(template_name="part/allocation.html"),
        name="part-allocation",
    ),
    url(
        r"^bom/?",
        views.PartDetail.as_view(template_name="part/bom.html"),
        name="part-bom",
    ),
    url(
        r"^build/?",
        views.PartDetail.as_view(template_name="part/build.html"),
        name="part-build",
    ),
    url(
        r"^used/?",
        views.PartDetail.as_view(template_name="part/used_in.html"),
        name="part-used-in",
    ),
    url(
        r"^suppliers/?",
        views.PartDetail.as_view(template_name="part/supplier.html"),
        name="part-suppliers",
    ),
    url(
        r"^orders/?",
        views.PartDetail.as_view(template_name="part/orders.html"),
        name="part-orders",
    ),
    url(
        r"^track/?",
        views.PartDetail.as_view(template_name="part/track.html"),
        name="part-track",
    ),
    url(
        r"^attachments/?",
        views.PartDetail.as_view(template_name="part/attachments.html"),
