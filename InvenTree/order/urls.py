...
purchase_order_detail_urls = [
    url(
        r"^cancel/?", views.PurchaseOrderCancel.as_view(), name="purchase-order-cancel"
    ),
    ...
    url(
        r"^receive/?",
        views.PurchaseOrderReceive.as_view(),
        name="purchase-order-receive",
    ),
    url(
        r"^complete/?",
        views.PurchaseOrderComplete.as_view(),
        name="purchase-order-complete",
    ),
    url(
        r"^export/?", views.PurchaseOrderExport.as_view(), name="purchase-order-export"
    ),
