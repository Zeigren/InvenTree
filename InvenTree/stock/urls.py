...
stock_location_detail_urls = [
    ...
    url(
        r"^delete/?", views.StockLocationDelete.as_view(), name="stock-location-delete"
    ),
...
stock_item_detail_urls = [
    ...
    url(
        r"^serialize/", views.StockItemSerialize.as_view(), name="stock-item-serialize"
    ),
    url(r"^delete/", views.StockItemDelete.as_view(), name="stock-item-delete"),
    url(r"^qr_code/", views.StockItemQRCode.as_view(), name="stock-item-qr"),
    url(
        r"^add_tracking/",
        views.StockItemTrackingCreate.as_view(),
        name="stock-tracking-create",
    ),
    url(
        r"^children/",
        views.StockItemDetail.as_view(template_name="stock/item_childs.html"),
        name="stock-item-children",
    ),
...
stock_tracking_urls = [
    ...
    url(
        r"^(?P<pk>\d+)/edit/",
        views.StockItemTrackingEdit.as_view(),
        name="stock-tracking-edit",
    ),
    # delete
    url(
        r"^(?P<pk>\d+)/delete",
        views.StockItemTrackingDelete.as_view(),
        name="stock-tracking-delete",
    ),
    # list
...
stock_urls = [
    ...
    url(
        r"^location/new/",
        views.StockLocationCreate.as_view(),
    ...
    url(
        r"^export-options/?",
        views.StockExportOptions.as_view(),
        name="stock-export-options",
    ),
