...
class StockLocationTest(StockViewTestCase):
    ...
    def test_location_edit(self):
        response = self.client.get(
            reverse("stock-location-edit", args=(1,)),
    ...
    def test_qr_code(self):
        ...
        response = self.client.get(
            reverse("stock-location-qr", args=(1,)),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(
            reverse("stock-location-qr", args=(999,)),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_create(self):
        ...
        response = self.client.get(
            reverse("stock-location-create"), HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        self.assertEqual(response.status_code, 200)

        # Create with a parent
        response = self.client.get(
            reverse("stock-location-create"),
            {"location": 1},
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
...
class StockItemTest(StockViewTestCase):
    ...
    def test_qr_code(self):
        ...
        response = self.client.get(
            reverse("stock-item-qr", args=(1,)), HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        self.assertEqual(response.status_code, 200)

        # QR code for an invalid item
        response = self.client.get(
            reverse("stock-item-qr", args=(9999,)),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_adjust_items(self):
        ...
        # Add items
        response = self.client.get(
            url, {"item": 1, "action": "add"}, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_item(self):
        ...
        response = self.client.get(
            reverse("stock-item-edit", args=(1,)),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(
            reverse("stock-item-edit", args=(100,)),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_serialize_item(self):
        ...
        response = self.client.post(
            url, data_valid, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(
            url, data_invalid, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.content)
        self.assertFalse(data["form_valid"])
