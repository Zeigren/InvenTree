...
company_detail_urls = [
    ...
    url(
        r"parts/?",
        views.CompanyDetail.as_view(template_name="company/detail_part.html"),
        name="company-detail-parts",
    ),
    url(
        r"stock/?",
        views.CompanyDetail.as_view(template_name="company/detail_stock.html"),
        name="company-detail-stock",
    ),
    url(
        r"purchase-orders/?",
        views.CompanyDetail.as_view(
            template_name="company/detail_purchase_orders.html"
        ),
        name="company-detail-purchase-orders",
    ),
...
price_break_urls = [
    ...
    url(
        r"^(?P<pk>\d+)/delete/",
        views.PriceBreakDelete.as_view(),
        name="price-break-delete",
    ),
]
...
supplier_part_detail_urls = [
    ...
    url(
        ...
        views.SupplierPartDetail.as_view(
            template_name="company/supplier_part_pricing.html"
        ),
        name="supplier-part-pricing",
    ),
    url(
        r"^orders/",
        views.SupplierPartDetail.as_view(
            template_name="company/supplier_part_orders.html"
        ),
        name="supplier-part-orders",
    ),
    url(
        r"^stock/",
        views.SupplierPartDetail.as_view(
            template_name="company/supplier_part_stock.html"
        ),
        name="supplier-part-stock",
    ),
